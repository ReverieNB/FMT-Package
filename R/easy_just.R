#' Place Figure Text
#'
#' Used for positioning trend figure data value text appropriately in figures. A simplified version of vjust_right
#' 
...
easy_just <- function (data, axis_max=100, axis_min=0, invert=TRUE, upper=1){
  data <- data %>%
